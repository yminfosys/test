$(document).ready(function(){
  ...
  function findDriver(){
    ...
    var isd='+44';
    $.post('/uk/admin/findDriver',{mobile:mobile,isd:isd},function(data){
        if(data!='worng'){
          //alert(data) 
          $("#Driver-search").css({"display":"none"});
          $("#verify-driver").css({"display":"block"});
          $(".user-image").html('<img src="/uk/'+data.photo+'">')
          ...
          $("#document").html('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">\
            <div class="thumbnail">\
              <img src="/uk/'+data.photo+'" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
              <div class="caption">\
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">\
            <div class="thumbnail">\
              <img src="/uk/'+data.Idproof+'" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
              <div class="caption">\
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">\
            <div class="thumbnail">\
              <img src="/uk/'+data.dl+'" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
              <div class="caption">\
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">\
            <div class="thumbnail">\
              <img src="/uk/'+data.rto+'" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
              <div class="caption">\
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">\
            <div class="thumbnail">\
              <img src="/uk/'+data.insurence+'" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
              <div class="caption">\
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">\
            <div class="thumbnail">\
              <img src="/uk/'+data.polution+'" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
              <div class="caption">\
  ...
  function verifyDriver(){
    ...
    var isd='+44';
    $.post('/uk/admin/verifyDriver',{mobile:mobile,isd:isd},function(data){
        if(data!='worng'){
            //alert(data) 
            $("#Driver-search").css({"display":"none"});
            $("#verify-driver").css({"display":"block"});
  ...
  function submitEngintype(){
    ...
    var isd='+44';
    $.post('/uk/admin/updateBasicDetails',{engintype:engintype,milege:milege,mobile:mobile,isd:isd,driverCity:driverCity,travelmod:travelmod},function(data){
      console.log(data);
      $("#mssg").html(data);
    });
  ...
  function updatePetrolPrice(){
    ...
    var cng=$("#cng").val();
    var city=$("#city").val();
    $.post('/uk/admin/updatedisealPetrol',{petrol:petrol,diesel:diesel,cng:cng,city:city},function(data){
      if(data){
