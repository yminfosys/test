...
function loginprocess(){
    ...
    var mobile=$("#mobile").val();
    $.post('/uk/login',{password:password,mobile:mobile},function(data){
        if(data=='success'){
            window.location='/uk/servecemode'
        }else{
...
////////CAll pickup placesearch content//////
        ...
        function searchdown(){
          ...
          function searchup(){
            ...
            timerr=setTimeout(function(){
              ...
              $.post('/uk/placesearch',{quary:quary,location:location},function(data){ 
            ...
            if(travelmod!=j){
              $.post('/uk/nearbytime',{
               ...
               if(resul.data.length>0){
                ...
                $.post('/uk/distbtwntime',{travelmod:j,orig:orig,diste:diste,count:resul.count},function(outp){
  ...
  function changeModeofTravel(tm){
    ...
    if($("#tmPrice"+tm+"").val()){
     ...
     // $("#booimg").html('<img class="tm-img" src="/uk/images/tm'+tm+'.png">')
        ...
        continueBooking(1);      
          ...
          if(Number(walletBalance)> 0){
            ...
            if(Number(buyKM)>Number(totalDistance) ){
              ...
              alert("You Don't have available balance cover your jurny please Recharge your Wallet or BuyMile");
            }
          }
   ...
   function continueBooking(payMode){
    ...
    $.post('/uk/nearbyRideBooking',{
      ...
      if(data.drivers.length > 0){
         ...
         /////Call to Driver///
         var count=0; 
         $.post('/uk/CallDriver',{pilotID:data.drivers[count].pilotID,CustID:CustID,pickuoAddress:originAds},function(result){
            console.log(result);
          }); 
         count++;
         ...
         socket.on('DriverAccepeCall', function (incomdata) {
          if(CustID==incomdata.CustID){
            ...
            tttt=setTimeout(function(){
              ...
              $.post('/uk/saveDriverCallAndBooking',{
                originAds:originAds,
                distAds:distAds,
      ...
      /////Search Pre-ride list/////
        $.post('/uk/nearbyPrerideDriver',{
          ...
          if(data.drivers.length > 0){
           /////Call to Driver///
           var count=0; 
           $.post('/uk/CallPreRideDriver',{pilotID:data.drivers[count].pilotID,CustID:CustID},function(result){
              console.log(result);
            }); 
           count++;
           timere=setInterval(function(){ 
            ...
            var tt;
             socket.on('PreRideDriverAccepeCall', function (incomdata) {
               if(CustID==incomdata.CustID){
                 ...
                 $.post('/uk/savePreRideCallAndBooking',{
                  pilotID:incomdata.pilotID,
...
//    await $.post('/uk/trstloop',{pilotID:pilotID}, function(data){
//      console.log(data)
//       if(data.bookings =="2"){
//         forLoop.close();        
//      }
