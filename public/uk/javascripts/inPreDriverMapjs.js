...
function initMap() { 
  ...
  if(setSystem=="ONLINE"){
        ...
        setTimeout(function(){
          $.post('/uk/drv/dutyUpdate',{duty:'offline'},function(data){
            ...
            //////dutyHours Count//////
             ...
             ////////Call CashCollection//////         
              window.location.href="../uk/preDriverCash?offline=1";
          });
        },1000);
    ...
    function onlineExicute(){     
      ...
      $.post('/uk/preRideCityFulepriceUpdate',{pilotID:pilotID},function(cityFule){
      ...
      $.post('/uk/preRidePageInitiate',{pilotID:pilotID,driverBusy:"busy"},function(rides){
  ...
  document.getElementById("continueNextRide").addEventListener("click", function(){ 
    ...
    //alert(bookingID)  
    $.post('/uk/finishandUpdateRide',{bookingID:bookingID},function(data){
      if(data){
        onlineExicute();
