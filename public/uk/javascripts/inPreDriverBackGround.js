...
function initMap() { 
    ...
    function LocationUpdate(position){     
        $.post('/uk/driverLocationUpdate',{lat:position.coords.latitude,lng:position.coords.longitude,accuracy:position.coords.accuracy, DriverType:"preRide" },function(data){
            console.log(data);
         });
